    ...
    <div className="">
      <header className="mx-6 mt-12 mb-24 md:mx-12 md:mt-20 md:mb-36 lg:mx-auto lg:w-1/2">
        ...
        <ul aria-label="Social Links" className="flex mt-4">
          <li className="mr-2">
            <a href="https://github.com/aviato" target="_blank">
              Github
            </a>
          </li>
          <li className="mr-2">
            <a href="https://www.linkedin.com/in/rsprice/" target="_blank">
              LinkedIn
            </a>
          </li>
          <li>
            <a href="mailto:rsprice90@gmail.com" target="_blank">
              Email
            </a>
          </li>
        </ul>
      ...
      <main className="mx-6 md:mx-12 lg:mx-auto lg:w-1/2">
        <section>
          ...
          <p className="mt-4">
            ...
            love bringing designs to life on the page, so I naturally favor
            front end work, but I am comfortable with back end work too. I have
            worked remotely since 2019, so I feel content working from home, but
            I love to interact with people in person as well!{" "}
          </p>
          <br />
          <p>
            When I&apos;m not at my desk solving problems, you can find me out
            in nature camping and playing music. I play drums, guitar, mandolin,
            and some piano. In the summer of 2023, I embarked on a series of
            road trips. The journey took me from Southern California to
            Flagstaff, Arizona. I then headed up to Northern California,
            traversed through Nevada, Utah, and Idaho, and finally reached my
            destination in Wyoming. I played my mandolin at several outdoor
            retreats along the way. I'm hoping to do something similar in 2024!
          </p>
        </section>
          ...
          <ul>
            <li>
              ...
              >
                ...
                something with OpenAI&apos;s API, so on this project I did both!
                I also used this project to practice using Tailwind CSS and
                Figma. I'm not a great designer but, hey, that's why you
                practice right? The project is very simple: take a prompt from
                the user and generate a short science fiction story with images
                from DALL·E.
                <br />
                <br />
                The images generated by DALL·E are saved to Cloudflare&apos;s R2
                storage via a Cloudflare Worker, and some other data is
                persisted with a PostgresQL DB that I run in a Docker container.
                The whole thing runs on a VPS I set up on Digital Ocean. Working
                with SvelteKit is very satisfying, and I would like to use it
